 ...
 */ !(function () {
    ...
    function e(e) {
      ...
      if (u) {
        ((a = o ? require('path').dirname(a) + '/' : __dirname + '/'),
          ...
          (L = function (e, t) {
            return (H(), (e = B.normalize(e)), n.readFileSync(e, t ? void 0 : 'utf8'));
          }),
      ...
      var E = {
        ...
        Ia: function (r, a) {
          ((r.onmessage = (e) => {
            ...
            (r.onerror = (e) => {
              throw (
                m('worker sent an error! ' + e.filename + ':' + e.lineno + ': ' + e.message),
                e
              );
            }),
            u &&
      ...
      function Xe(e, t, n, r) {
        ...
        var l,
          ...
          f = {
            ...
            '%j': function (e) {
              return o(e.la + ze(O(e.da + 1900) ? R : C, e.ha - 1), 3);
            },
            '%m': function (e) {
              return o(e.ha + 1, 2);
            },
              ...
              return i(n, (e = new Date(e.da + 1900, e.ha, e.la))) < 0
                ? o(
                    Math.ceil(
                      (31 -
                        n.getDate() +
                        (ze(O(e.getFullYear()) ? R : C, e.getMonth() - 1) - 31) +
                        e.getDate()) /
                        7,
                    ),
                    2,
      ...
      E.Fa();
      var Je,
        Ke = [null, ve, ke, Ee, De, Te, je, He, Ye, Ue, Ne, Ve, Ge],
        Ze = {
          p: function (e, t) {
            $e(e, t);
          },
          ...
          w: function (e, t, n) {
            var r;
            for (T.length = 0, n >>= 2; (r = l()[t++]);)
              ((r = r < 105) && 1 & n && n++, T.push(r ? q()[n++ >> 1] : h()[n]), ++n);
            return d ? I.apply(null, [-1 - e, 0].concat(T)) : _e[e].apply(null, T);
          },
          h: function () {
            u ||
              o ||
          ...
          D: function (e, t, n) {
            ((Ie.length = t), (n >>= 3));
            for (var r = 0; r < t; r++) Ie[r] = q()[n + r];
            return (e < 0 ? _e[-e - 1] : Ke[e]).apply(null, Ie);
          },
          A: function (e) {
            var t = l().length;
      ...
      function mt(e) {
        ...
        (b() || d || E.ua(), b() || (E.ua(), c.onExit && c.onExit(e), (K = !0)), r(e, new P(e)));
      }
      if (
  ...
  function a() {
    for (; t.length && (!f._isSearching || !f._isSearching());) n(t.shift());
  }
  function o(e) {
  ...
  function p() {
    if (f._isReady && !f._isReady()) return setTimeout(p, 10);
    var n;
    ('undefined' == typeof IS_ASYNCIFY
      ? (f.onDoneSearching = a)
      : (f.onDoneSearching = function () {
          setTimeout(a, 1);
        }),
      (f.processCommand = o),
      r.length &&
        ...
        (function e() {
          for (var t; n < r.length;) {
            if ((t = r[n++]).startsWith('sleep ')) return setTimeout(e, t.slice(6));
            o(t);
          }
        })()));
  }
  function m(e, t, n) {
    var n = e / ((Date.now() - n || 1) / 1e3),
      r = 0 < n && e < t ? (t - e) / n : 0;
    return {
      percent: e / t,
      loaded: e,
      ...
      eta: r,
      etaText:
        !(t = r) || t < 0 ? '' : t < 60 ? Math.ceil(t) + ' sec' : Math.round(t / 60) + ' min',
    };
  }
  function i(t) {
    var r, a;
      ...
      return fetch(e).then(function (e) {
        ...
        if (e.ok)
          return (
                ...
                !(function n() {
                  t.read()
                    .then(function (e) {
                      ...
                      t
                        ? (s(i, a, a), r.close())
                        : ((o += e.byteLength), s(i, o, a), r.enqueue(e), n());
                    })
                    .catch(function e(t) {
                      (r.error(t), e(t));
                    });
            ...
            new Response(n, { status: e.status, statusText: e.statusText, headers: r })
          );
      ...
      return function (e, t, n) {
        c &&
          ...
          (r =
            r ||
            setTimeout(function () {
              ((r = null), c.postMessage(a), 1 <= a.percent && (c.close(), (c = null)));
            }, 4)));
      };
    }
    ((f = {
      ...
      instantiateWasm: function (t, n) {
        ...
        return o(u, e)
          ...
          .then(function (e) {
            return (n(e.instance, e.module), e.instance.exports);
          })
          .catch(function (e) {
  ...
  ('undefined' != typeof global &&
    ...
    : ('undefined' != typeof onmessage &&
          ...
          ? require.main === module
            ? ((e = require('path')),
              ...
              require('readline')
                ...
                .on('line', function (e) {
                  e &&
                    (f.processCommand ? f.processCommand(e) : r.push(e), 'quit' === e) &&
                    process.exit();
                })
                .on('close', function () {
                  process.exit();
          ...
          : ((e = self.location.hash.substr(1).split(',')),
            ...
            (onmessage =
              ...
              function (e) {
                ...
                else if (e.data.progressPort) c = e.data.progressPort;
                else if (
                  (f.processCommand ? f.processCommand(e.data) : r.push(e.data), 'quit' === e.data)
                )
                  try {
                    self.close();
                  } catch (e) {}
      ...
      : 'object' == typeof document && document.currentScript
        ? (document.currentScript._exports = d())
        : (s = d());
})();
